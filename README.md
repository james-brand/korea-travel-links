# Hanok Days — Korea Travel Guides
...
Visas, money, connectivity — the things to settle before you fly.
...
- **[Cash or Card in Korea? The Apps That Won't Take Your Foreign Card](https://hanokdays.com/posts/cash-or-card-in-korea/)**
  Korea is a card society — until you try Kakao Taxi, a delivery app, or a market stall.

- **[Can Foreigners Use Korean ATMs? Fees, the 'Global' Button, and What Fails](https://hanokdays.com/posts/korean-atms-for-foreigners/)**
  Not every Korean ATM takes a foreign card, even inside the same convenience store.

- **[How Much Does a Week in Korea Cost? A Real Breakdown by Category](https://hanokdays.com/posts/week-in-korea-cost/)**
  A week in Korea runs roughly $500 backpacker, $1,200 mid-range, or $2,200+ comfort — but the useful part is where the money goes.

- **[Buying K-Beauty in Korea: The Instant Tax Refund and the Sale Calendar](https://hanokdays.com/posts/kbeauty-shopping-guide/)**
  Olive Young gives foreigners an instant in-store tax refund from ₩15,000 with just a passport — and the quarterly sales plus foreign-pay discounts stack.

## Getting Around

Transit cards, trains and the apps that actually work in Korea.

- **[Getting Around Korea: The Transport Guide That Connects the Details](https://hanokdays.com/posts/getting-around-korea/)**
  One transit card covers the whole country, but the rules differ by region and the apps aren't the ones you expect.

- **[Seoul Subway: Tap-Out Rules That Changed in 2026](https://hanokdays.com/posts/seoul-subway-guide/)**
...
- **[Korean Beer: Local Brands, Strengths, and the 4-for-₩10,000 Deal](https://hanokdays.com/posts/korean-beer-guide/)**
  Cass, Terra and Kelly sit around 4.5–4.6%, the convenience-store 4-for-₩10,000 deal has quiet rules, and somaek is the point of it all.

- **[Pojangmacha: How to Read a Korean Street-Food Tent (and Not Get Ripped Off)](https://hanokdays.com/posts/pojangmacha-guide-korea/)**
  Pojangmacha are cash-only street-food tents with no printed prices — which makes them intimidating.

- **[Makgeolli: Which Bottles You Can Shake and Which You Can't](https://hanokdays.com/posts/makgeolli-guide-korea/)**
  Makgeolli comes in two kinds — raw and pasteurised — and only one is safe to shake or store. Guides tell you to shake it without saying which bottle will leak.

- **[Anju: Why You Can't Just Order Drinks in Korea](https://hanokdays.com/posts/anju-guide-korea/)**
  Anju is food ordered to go with drinks — and at many Korean bars it's close to mandatory.

- **[Korean Hangover Cures: What Actually Works (and What's Just a Drink)](https://hanokdays.com/posts/korean-hangover-cures/)**
  Korea's convenience-store hangover drinks are a fast-growing market worth over ₩370 billion — but none is an approved medicine, and doctors are sceptical.

- **[Korean Convenience Stores: The Microwave Rule, the Parasol Grey Area, and the Service Counter](https://hanokdays.com/posts/convenience-store-guide/)**
  Korean convenience stores are a food destination, but there are rules — the parasol tables are technically illegal to drink at, and seating is not standard.

## Jeju

The island: reservations, buses, and what closes when.

- **[Jeju Travel Budget: What a Trip Actually Costs, With or Without a Car](https://hanokdays.com/posts/jeju-travel-budget/)**
  Jeju is pricier than mainland Korea in the ways that matter — car rental, taxis, ferries.

- **[Jeju Itinerary: 3-Day and 5-Day Plans That Actually Work Without a Car](https://hanokdays.com/posts/jeju-itinerary-3-and-5-days/)**
...
All guides: [hanokdays.com](https://hanokdays.com)